...
def submit_complaint():
    try:
        ...
        # Accept both English and Hindi field names
        name = data.get("name") or data.get("शिकायतकर्ता का नाम")
        location = data.get("location") or data.get("स्थान")
        department = data.get("department") or data.get("विभाग")
        description = data.get("description") or data.get("शिकायत")
